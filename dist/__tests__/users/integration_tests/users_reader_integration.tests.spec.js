...
const user_repo_reader_pg_1 = require("../../../src/modules/users/repositories/user_repo_reader_pg");
describe("UserRepoReaderPg (integration - transactional)", () => {
    ...
    beforeEach(async () => {
        ...
        repo = new user_repo_reader_pg_1.UserRepoReaderPg(client);
    });
    afterEach(async () => {
    ...
    it("should return user by id", async () => {
        ...
        const user = await repo.getUserById("11111111-1111-1111-1111-111111111111");
    ...
    it("should return null if user not found by id", async () => {
        const user = await repo.getUserById("22222222-2222-2222-2222-222222222222");
