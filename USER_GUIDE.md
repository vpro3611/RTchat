...
![Welcome Screen (Light Mode)](docs/assets/welcome_light_theme.png)
![Welcome Screen (Dark Mode)](docs/assets/welcome_black_theme.png)
...
![Chat Room with Media](docs/assets/supported_messages_demonstration.png)
...
![Participants Dialog](docs/assets/participants_view.png)
...
![Banned Participants](docs/assets/banned_participants_view.png)
...
![Blocked Users List](docs/assets/blocked_users_screen.png)
...
![Find People](docs/assets/find_users_network.png)
...
![Outgoing Requests](docs/assets/requests_for_joining.png)
...
![Theme Switcher](docs/assets/theme_switcher.png)
...
![Saved Messages](docs/assets/saved_messages.png)
*Keep track of important information with personal bookmarks. It is also possible to navigate to the source of a message.*
